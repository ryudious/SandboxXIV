...
namespace SandboxXIV
{
  public static class Memory
  {
    ...
    private static __FnPtr<void (IntPtr, ushort)> _spawnLockOn;
    ...
    public static unsafe void Initialize()
    {
      ...
      try
      {
        ...
        Memory._spawnLockOn = (__FnPtr<void (IntPtr, ushort)>) (IntPtr) (void*) (DalamudApi.SigScanner.ScanModule("48 83 EC ?? 8B EA 48 8B F9 BB") - 16);
      }
      catch
      {
    ...
    public static void SpawnLockOn(IntPtr actor, ushort lockOn) => __calli(Memory._spawnLockOn)((ushort) actor, (IntPtr) lockOn);
    ...
    public class Replacer : IDisposable
    {
      ...
      public Replacer(IntPtr addr, byte[] bytes, bool startEnabled = false)
      {
        ...
        this.Address = addr;
        this.newBytes = bytes;
        SafeMemory.ReadBytes(addr, bytes.Length, ref this.oldBytes);
      ...
      public Replacer(string sig, byte[] bytes, bool startEnabled = false)
      {
        ...
        this.Address = num;
        this.newBytes = bytes;
        SafeMemory.ReadBytes(num, bytes.Length, ref this.oldBytes);
        Memory.createdReplacers.Add(this);
        if (!startEnabled)
          return;
        this.Enable();
