        ...
        public static unsafe bool IsAlternatePhysics
        {
            get
            {
                if (PhysicsEditor.freezePhysicsBoolPtr == IntPtr.Zero)
                    return true;
                return *(byte*)(void*)PhysicsEditor.freezePhysicsBoolPtr != 0 && *(sbyte*)(void*)PhysicsEditor.housingUpwarpBoolPtr != 0;
            }
            set
            {
                if (PhysicsEditor.freezePhysicsBoolPtr != IntPtr.Zero)
                    *(sbyte*)(void*)PhysicsEditor.freezePhysicsBoolPtr = (sbyte)(value ? 1 : 0);
                if (!(PhysicsEditor.housingUpwarpBoolPtr != IntPtr.Zero))
                    return;
                *(sbyte*)(void*)PhysicsEditor.housingUpwarpBoolPtr = (sbyte)(value ? 1 : 0);
            }
        }
