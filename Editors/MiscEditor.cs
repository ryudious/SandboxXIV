...
// Type: SandboxXIV.Editors.MiscEditor
...
namespace SandboxXIV.Editors
{
  public class MiscEditor : Editor
  {
    ...
    public readonly Memory.Replacer antiAFKKicker = new Memory.Replacer("0F 86 ?? ?? ?? ?? 0F 2F C7 0F 86", new byte[2]
    {
      (byte) 144,
      (byte) 233
    }, (SandboxXIV.SandboxXIV.Config.FUCKTHEAFKKICKER ? 1 : 0) != 0);
    public readonly Memory.Replacer antiDungeonKicker = new Memory.Replacer("76 ?? B1 01 E8 ?? ?? ?? ?? C7", new byte[1]
    {
      (byte) 235
    }, (SandboxXIV.SandboxXIV.Config.FUCKTHEDUNGEONKICKER ? 1 : 0) != 0);
    public readonly Memory.Replacer antiNoviceNetworkKicker = new Memory.Replacer("0F 86 ?? ?? ?? ?? 48 8B 8F ?? ?? ?? ?? 48 8B 01 FF 90 ?? ?? ?? ?? 48 8B 88", new byte[2]
    {
      (byte) 144,
      (byte) 233
    }, (SandboxXIV.SandboxXIV.Config.FUCKTHENOVICENETWORKKICKER ? 1 : 0) != 0);
    ...
    {
      if (!SandboxXIV.SandboxXIV.Config.EnableSkipCutsceneMenu)
        return;
    ...
    protected override void Draw()
    {
      ...
      if (ImGui.Checkbox("Enable Skip Cutscene Menu", ref SandboxXIV.SandboxXIV.Config.EnableSkipCutsceneMenu))
      ...
      {
        SandboxXIV.SandboxXIV.Config.FUCKTHEAFKKICKER = !this.antiAFKKicker.IsEnabled;
        SandboxXIV.SandboxXIV.Config.Save();
      }));
      ReplacerCheckbox(this.antiDungeonKicker, "Anti Dungeon Kicker", (System.Action) (() =>
      {
        SandboxXIV.SandboxXIV.Config.FUCKTHEDUNGEONKICKER = !this.antiDungeonKicker.IsEnabled;
        SandboxXIV.SandboxXIV.Config.Save();
      }));
      ReplacerCheckbox(this.antiNoviceNetworkKicker, "Anti Novice Network Kicker", (System.Action) (() =>
      {
        SandboxXIV.SandboxXIV.Config.FUCKTHENOVICENETWORKKICKER = !this.antiNoviceNetworkKicker.IsEnabled;
        SandboxXIV.SandboxXIV.Config.Save();
      }));
      ImGui.Columns(1);
