...
// Type: SandboxXIV.Editors.ActionEditor
...
namespace SandboxXIV.Editors
{
  public class ActionEditor : Editor
  {
    ...
    public ActionEditor()
    {
      ...
      if (SandboxXIV.SandboxXIV.Config.EnableActionEditing)
    ...
    protected override void Draw()
    {
      ...
      if (ImGui.BeginTabItem("General"))
      {
        ...
        if (ImGui.Checkbox("Enable Action Editing", ref SandboxXIV.SandboxXIV.Config.EnableActionEditing))
        {
          this.ToggleActionEditing(SandboxXIV.SandboxXIV.Config.EnableActionEditing);
          SandboxXIV.SandboxXIV.Config.Save();
        }
        ImGui.NextColumn();
        if (ImGui.Checkbox("Enable Omens for The Slice Is Right", ref SandboxXIV.SandboxXIV.Config.EnableSliceOmens))
          SandboxXIV.SandboxXIV.Config.Save();
        ImGui.Spacing();
        ImGui.Separator();
        ImGui.Spacing();
      ...
      if (SandboxXIV.SandboxXIV.Config.EnableActionEditing)
      {
        if (ImGui.BeginTabItem("Action Info"))
        {
          ...
          if (this._action != null)
          {
            ...
            if (flag1)
            {
              ...
              SandboxXIV.SandboxXIV.Config.ActionMods.Add(actionMod);
        ...
        if (ImGui.BeginTabItem("Saved Action Mods"))
        {
          ...
          for (int index = 0; index < SandboxXIV.SandboxXIV.Config.ActionMods.Count; ++index)
          {
            ActionMod actionMod = SandboxXIV.SandboxXIV.Config.ActionMods[index];
            ...
            if (ImGui.IsItemHovered())
            {
              ...
              {
                SandboxXIV.SandboxXIV.Config.ActionMods.RemoveAt(index);
                ActionEditor.AddStagingAction(actionMod.ID);
                SandboxXIV.SandboxXIV.Config.Save();
              }
            }
            ...
            if (index < SandboxXIV.SandboxXIV.Config.ActionMods.Count - 1)
              ImGui.Separator();
          }
          ImGui.EndTabItem();
        }
...
label_7:
    ...
    {
      if (!SandboxXIV.SandboxXIV.Config.EnableSliceOmens || DalamudApi.ClientState.TerritoryType != (ushort) 144)
        return;
      foreach (GameObject gameObject in DalamudApi.ObjectTable)
      {
        if (gameObject is EventObj eventObj)
        {
          ...
          {
            case 2010777:
              Omen omen1 = new Omen((GameObject*) (void*) ((GameObject) eventObj).Address, 2U, 2.5f, 28f, false, 10.3f, 1.570796f);
              ...
              continue;
            case 2010778:
              Omen omen2 = new Omen((GameObject*) (void*) ((GameObject) eventObj).Address, 188U, 2.5f, 28f, true, 10.3f, 1.570796f);
              ...
              continue;
            case 2010779:
              Omen omen3 = new Omen((GameObject*) (void*) ((GameObject) eventObj).Address, 168U, 11f, false, 10.3f);
    ...
    private static void SetupStagingActions()
    {
      ...
      SandboxXIV.SandboxXIV.Config.ActionMods.ForEach((System.Action<ActionMod>) (mod =>
      {
        if (!mod.Enabled)
          return;
